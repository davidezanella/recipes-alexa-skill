...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: any recipes for [vegetarians]{"entity": "vegetarian", "value": "true"}?   <!-- predicted: search_recipe: any recipes for [vegetarians](vegetarian)? -->
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: find some recipes for [vegans]{"entity": "vegan", "value": "true"}   <!-- predicted: search_recipe: find some recipes for [vegans](vegan) -->
    - slot{"vegan": "vegans"}
    - action_form_search_recipe
    - form{"name": "action_form_search_recipe"}
    - slot{"vegan": true}
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: i need a recipe ready in [60](max_minutes) minutes for [vegetarians]{"entity": "vegetarian", "value": "true"} where i can use [rosemary](search_ingredients)   <!-- predicted: search_recipe: i need a recipe ready in [60](max_minutes) minutes for [vegetarians](vegetarian) where i can use rosemary -->
    - slot{"max_minutes": "60"}
    - slot{"vegetarian": "vegetarians"}
    - action_form_search_recipe
    - form{"name": "action_form_search_recipe"}
...
* affirm: Sure, let's start!
    - action_next_step   <!-- predicted: utter_rephrase -->
    - slot{"step_index": 1}
* next_step: done
    - action_next_step
    - slot{"step_index": 2}
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: i can eat at maximum [175](max_calories) calories, find a recipe where i can use [pineapple](search_ingredients) but without [rosemary](avoid_ingredients)   <!-- predicted: search_recipe: i can eat at maximum [175](max_calories) calories, find a recipe where i can use pineapple but without rosemary -->
...
* get_recipe_info: Tell me more about the [third]{"entity": "ordinal", "value": "3"} one
    ...
    - slot{"chosen_recipe": 3}
    - action_get_recipe_info
* search_recipe: please find some [without gluten]{"entity": "gluten_free", "value": "true"}   <!-- predicted: search_recipe: please find some [without gluten](gluten_free) -->
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: i need a recipe with maximum [120](max_calories) calories, that takes maximum [70](max_minutes) minutes for [vegans]{"entity": "vegan", "value": "true"}   <!-- predicted: search_recipe: i need a recipe with maximum [120](max_calories) calories, that takes maximum [70](max_minutes) minutes for [vegans](vegan) -->
...
* start_cooking: ok, i want to cook it!
    - action_start_cooking
    - slot{"step_index": 0}
* affirm: Yes, go on   <!-- predicted: next_step: Yes, go on -->
    - action_next_step
    - slot{"step_index": 1}
...
* search_recipe: i need a recipe ready in [80](max_minutes) minutes
    ...
    - slot{"max_minutes": 70}
    - form{"name": null}
* get_recipe_steps: Explain the steps needed for the [third]{"entity": "ordinal", "value": "3"} recipe   <!-- predicted: get_recipe_ingredients: Explain the steps needed for the [third]{"entity": "ordinal", "value": "3"} recipe -->
    - slot{"ordinal": 3}
    - action_choose_recipe   <!-- predicted: utter_rephrase -->
    - slot{"chosen_recipe": 3}
    - action_get_recipe_steps   <!-- predicted: action_get_recipe_ingredients -->
...
## say hello (tests/conversation_tests.md)
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: i would like to cook using [rosemary](search_ingredients), [meat](search_ingredients) and [carrots](search_ingredients)   <!-- predicted: search_recipe: i would like to cook using rosemary, meat and [carrots](search_ingredients) -->
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: i would like to cook something but avoiding to use [pineapple](avoid_ingredients)   <!-- predicted: search_recipe: i would like to cook something but avoiding to use [pineapple](search_ingredients) -->
    - slot{"search_ingredients": ["pineapple"]}
    - action_form_search_recipe
    - form{"name": "action_form_search_recipe"}
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: i would like to cook something without using [pineapple](avoid_ingredients) or [carrots](avoid_ingredients)   <!-- predicted: search_recipe: i would like to cook something without using pineapple or [carrots](avoid_ingredients) -->
...
* greet: hello there!
    - utter_greet   <!-- predicted: utter_rephrase -->
* search_recipe: can you find a recipe for a [gluten free]{"entity": "gluten_free", "value": "true"} [pie](search_text)   <!-- predicted: search_recipe: can you find a recipe for a [gluten free](gluten_free) [pie](search_text) -->
